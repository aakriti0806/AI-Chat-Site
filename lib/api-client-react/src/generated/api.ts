...
export const renameOpenaiConversation = async (id: number,
    openaiConversationRename: OpenaiConversationRename, options?: RequestInit): Promise<OpenaiConversation> => {
...
export const getRenameOpenaiConversationMutationOptions = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof renameOpenaiConversation>>, TError,{id: number;data: BodyType<OpenaiConversationRename>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof renameOpenaiConversation>>, TError,{id: number;data: BodyType<OpenaiConversationRename>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof renameOpenaiConversation>>, {id: number;data: BodyType<OpenaiConversationRename>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RenameOpenaiConversationMutationBody = BodyType<OpenaiConversationRename>
...
export const useRenameOpenaiConversation = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof renameOpenaiConversation>>, TError,{id: number;data: BodyType<OpenaiConversationRename>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: number;data: BodyType<OpenaiConversationRename>},
        TContext
      > => {
